%% Swarm Control
% This script simulates a swarm aggregation routine based on global
% communication and artifical potential functins (Gazi and Passino 2002/3).
...
for i = 2:max_iter
    ...
    %         disp(count_N);
            ...
            del_pos = gazi_aggregation(t, S0(j, :)', logs_N);
            if (norm(del_pos) > vp)
...
t = [1:max_iter] * tsamp;
save(strcat('results/logs-gazi-2-', num2str(num_robots), '-', num2str(max_iter), '.mat'), 'logs', 't', 'R_th', 'R_start');